...
scoreboard players set @s sorcery.mana_aura 1

attribute @s generic.max_health modifier remove 53da1883-cb6d-4726-937e-7805dabb834a
# execute if score #aura sorcery.settings matches 1 run attribute @s generic.max_health modifier add 53da1883-cb6d-4726-937e-7805dabb834a "sorcery.aura" 0 add
...
execute if score @s sorcery.last_aura matches 2.. run scoreboard players add @s sorcery.max_cooldown 2
execute if score @s sorcery.last_aura matches 4.. run scoreboard players add @s sorcery.max_cooldown 3
