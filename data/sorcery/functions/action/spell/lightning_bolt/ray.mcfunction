...
execute at @e[type=!#sorcery:noai,tag=!global.ignore,tag=!global.ignore.kill,dx=1,dy=1,dz=1,tag=!sorcery.launcher] run function sorcery:action/spell/lightning_bolt/end
