...
execute store result entity @e[type=armor_stand,distance=..1,limit=1,tag=sorcery.godspell.sword.r] Pose.RightArm[0] float 0.001 run scoreboard players get #temp sorcery.use
execute store result entity @e[type=armor_stand,distance=..1,limit=1,tag=sorcery.godspell.sword.l] Pose.LeftArm[0] float 0.001 run scoreboard players get #temp sorcery.use
