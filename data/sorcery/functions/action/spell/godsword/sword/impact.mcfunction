...
execute if score #temp sorcery.use matches 1 if entity @e[type=armor_stand,tag=sorcery.godspell.sword.combo,distance=..3] run scoreboard players set #temp sorcery.use 0
