...
execute unless score #succes sorcery.use matches 0 unless score #succes sorcery.use matches 1 run schedule function sorcery:action/drop/magic/schedule 6t
