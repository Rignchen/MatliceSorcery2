...
execute if score #temp sorcery.use matches 1 positioned ~ ~-.15 ~ if entity @s[distance=...1] if data entity @s Item.tag.sorcery.wand.enchant run function sorcery:action/drop/wand/
