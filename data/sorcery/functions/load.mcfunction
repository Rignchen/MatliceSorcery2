...
#book
data modify storage sorcery:item all.book set value {					Slot:16b,id:"minecraft:written_book",				Count:1b,tag:{ctc:{id:"magic_wand",				from:"spr:matlice_sorcery",traits:{"book":1b}},			CustomModelData:419701,	sorcery:{book:1b},			display:{Name:'[{"text":"Book of sorcery",		"italic":false,"color":"light_purple"}]',	Lore:['{"translate":"All sorcery knoledge writte in a book ?",		"italic":false,"color":"light_gray"}','{"translate":"Matlice Sorcery","color":"blue","italic":true}']},														HideFlags:5}}
#spells
